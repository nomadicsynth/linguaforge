...
def setup_arg_parser():
    ...
    parser.add_argument("--logging_strategy", type=str, default="steps", help="Logging strategy", choices=["no", "steps", "epoch"])
    parser.add_argument("--logging_steps", type=int_or_float, default=10, help="Number of steps between logging")
    ...
    parser.add_argument("--eval_strategy", type=str, default="no", help="Evaluation strategy", choices=["no", "steps", "epoch"])
